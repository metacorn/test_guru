...
def create_test(title, category, level=0)
  category_id = Category.find_by(title: category).id
  test = Test.new(title: title, category_id: category_id)
  test.level = level
  test.save
end
# Method to create questions and answers.
...
# Tests categories seeding.
create_categories('History', 'Cinema', 'Football')
# World Cup test, questions and answers seeding.
...
# Middle Ages test, questions and answers seeding.
...
# Oscar Award test, questions and answers seeding.
...
# International Cinema test, questions and answers seeding.
...
# Supporters test, questions and answers seeding.
